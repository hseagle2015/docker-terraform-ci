ARG TERRAFORM_VERSION="1.10.1" # github-tags/hashicorp/terraform&versioning=semver
ARG EGET_VERSION="1.3.4" # github-tags/zyedidia/eget&versioning=semver
ARG CHECKOV_VERSION="3.2.317" # github-tags/bridgecrewio/checkov&versioning=semver

ARG TERRAFORM_VERSION="1.9.8" # github-tags/hashicorp/terraform&versioning=semver
ARG EGET_VERSION="1.3.4" # github-tags/zyedidia/eget&versioning=semver
ARG CHECKOV_VERSION="3.2.268" # github-tags/bridgecrewio/checkov&versioning=semver
...
ARG SOPS_VERSION="3.9.1" # github-tags/getsops/sops&versioning=semver
